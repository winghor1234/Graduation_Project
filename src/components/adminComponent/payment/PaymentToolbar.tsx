        ...
        <div className="flex justify-between gap-4">
            ...
            <div className="flex gap-2">
                ...
                <DropdownMenu>
                    ...
                    <DropdownMenuContent>
                        <DropdownMenuItem onClick={() => table.setSort("payment_date", "desc")}>
                            ໃໝ່ສຸດ
                        </DropdownMenuItem>
                        <DropdownMenuItem onClick={() => table.setSort("payment_date", "asc")}>
                            ເກົ່າສຸດ
                        </DropdownMenuItem>
                        <DropdownMenuItem onClick={() => table.setSort("amount", "desc")}>
                            ຈຳນວນເງິນ (ສູງ → ຕ່ຳ)
                        </DropdownMenuItem>
                        <DropdownMenuItem onClick={() => table.setSort("amount", "asc")}>
                            ຈຳນວນເງິນ (ຕ່ຳ → ສູງ)
                        </DropdownMenuItem>
                    </DropdownMenuContent>
                </DropdownMenu>
